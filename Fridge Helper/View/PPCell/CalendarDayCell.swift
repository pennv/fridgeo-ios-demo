...
extension CalendarDayCell: ListBindable {
    ...
    // This method will be called while redering each single cell
    // with unique data model of each cell that is used to pass data to the view
    ...
    func bindViewModel(_ viewModel: Any) {
        ...
        var dots = ""
        for _ in 0..<viewModel.expiredFridgeItems {
            dots += "."
        }
        dotsLabel.text = dots
    }
